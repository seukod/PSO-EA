...
=======================================================
Carga, alinea y analiza estadísticamente 30 ejecuciones de PSO.

Uso desde terminal:
    python analizar_pso.py          # Análisis completo
    python analizar_pso.py --solo-stats  # Solo estadísticas (sin gráficos)
...
PATRON_ARCHIVOS = "tabla*.csv"
SALIDA_STATS = "pso_estadisticas_resumen.csv"
SALIDA_CONV = "analisis_pso_convergencia.png"
SALIDA_VAR = "analisis_pso_variabilidad.png"
...
def graficar_convergencia(df_stats, output_path):
    ...
    ax1.set_title("Convergencia PSO - 30 Ejecuciones Independientes (Intervalo de Confianza 95%)", 
...
def graficar_variabilidad(df_stats, output_path):
    ...
    ax.set_title("Variabilidad de Fitness a lo largo del PSO (CV = σ/μ × 100)", 
                 fontsize=13, fontweight='bold', pad=15)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Análisis estadístico de 30 ejecuciones PSO",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Ejemplos de uso:
  python analizar_pso.py                    # Análisis completo con gráficos
  python analizar_pso.py --solo-stats       # Solo estadísticas, sin visualización
  python analizar_pso.py -o resultados/     # Guardar outputs en directorio
        """
    )
    ...
    print("="*70)
    print("ANÁLISIS PSO - 30 EJECUCIONES INDEPENDIENTES")
    print("="*70)
